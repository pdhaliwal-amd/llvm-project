...
// RUN: %libomptarget-compile-amdgcn-amd-amdhsa && env LIBOMPTARGET_DEBUG=1 %libomptarget-run-amdgcn-amd-amdhsa 2>&1 | %fcheck-amdgcn-amd-amdhsa -allow-empty -check-prefix=DEBUG
